  ...
  return <section id="beneficios" className="py-20 gradient-bg relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-16 fade-in">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">Oferecemos produtos para tratar frizz, manchas, queda de cabelo e outros problemas que afetam a autoestima das mulheres!</p>
        </div>
