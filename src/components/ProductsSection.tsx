  ...
  return <section id="produtos" className="py-8 sm:py-12 lg:py-16 xl:py-20 bg-white overflow-hidden">
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="text-center mb-8 sm:mb-12 lg:mb-16 fade-in">
          ...
          <p className="text-sm sm:text-base lg:text-lg xl:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed px-4">Produtos aprovados e recomendados por milhares de clientes, que fazem a diferença no dia a dia, com eficácia e resultados reais.</p>
        </div>
